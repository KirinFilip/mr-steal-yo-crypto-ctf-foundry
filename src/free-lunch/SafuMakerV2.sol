...
contract SafuMakerV2 is Ownable {
    ...
    constructor(address _factory, address _bar, address _safu, address _usdc) public {
    ...
    function _swap(address fromToken, address toToken, uint256 amountIn, address to)
        internal
        returns (uint256 realAmountOut)
    {
