...
contract AssetWrapper is AssetHolder, Ownable {
    ...
    function wrap(uint256 nftId, address assetOwner, address assetAddress) public {
        ...
        require(
            owner == msg.sender || isApprovedForAll(owner, msg.sender) // approval for all WLed contracts
    ...
    function unwrap(address assetOwner, address assetAddress) public {
        ...
        require(
            assetOwner == msg.sender || isApprovedForAll(assetOwner, msg.sender) // approval for all WLed contracts
    ...
    function _wrap(address assetOwner, address assetAddress, uint256 nftId) private {
